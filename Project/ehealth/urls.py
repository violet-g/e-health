...
urlpatterns = patterns('',
        ...
        url(r'^profile/$', views.profileRedirect, name='own_profile'),
        url(r'^test_ajax/$', views.test_ajax, name='test_ajax'),
        url(r'^privacy_details_ajax/$', views.privacy_details_ajax, name='privacy_details_ajax'),
        url(r'^save_folder_privacy_ajax/$', views.save_folder_privacy_ajax, name='save_folder_privacy_ajax'),
